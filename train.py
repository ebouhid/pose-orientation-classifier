...
if __name__ == "__main__":
    ...
    train_dataset = OrientationDataset(
        assets_dir, split_csv='split_csvs/train.csv', transform=transform)
    val_dataset = OrientationDataset(
        assets_dir, split_csv='split_csvs/val.csv', transform=transform)
    ...
    trainer = pl.Trainer(max_epochs=10, accelerator='cuda', callbacks=[
                         checkpoint_callback], log_every_n_steps=5)
